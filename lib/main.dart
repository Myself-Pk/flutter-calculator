...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const PrathamCalculator(),
    );
  }
}

class PrathamCalculator extends StatefulWidget {
  const PrathamCalculator({super.key});

  @override
  State<PrathamCalculator> createState() => _PrathamCalculatorState();
}

class _PrathamCalculatorState extends State<PrathamCalculator> {
  var userInput = '';
  var answer = '';
